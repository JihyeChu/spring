...
//	PlaformTransactionManager 대신 TransactionTemplate 객체를 사용해서 트랜잭션을 처리한다.
//	TransactionTemplate 객체를 선언하고 servlet-context.xml 파일에서 bean을 설정한다.
...
//					card, ticket 테이블의 insert sql 명령을 실행한다.
					template.update(new PreparedStatementCreator() {
